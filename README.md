...
If you are using a PE version with puppetserver (3.7 and later) you will also need the [puppetlabs-puppetserver_gem](https://github.com/puppetlabs/puppetlabs-puppetserver_gem) module.
